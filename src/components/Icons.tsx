...
export const IconFlame = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M12 22c4.5 0 7.5-2.8 7.5-7 0-3.2-2-5.9-3.5-7.5-.6-.6-1.6-.2-1.6.7v.6c0 1.3-1 1.6-1.7.4C11.6 7 11 5 11 3.5 11 2.5 9.9 2 9.4 2.8 7.3 6.2 4.5 9.9 4.5 15c0 4.2 3 7 7.5 7Z" />
