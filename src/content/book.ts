...
export const BOOK: Book = {
  ...
  description:
    'Interactive course companion for the Speakout A2 Student\u2019s Book \u2013 every unit, grammar reference, vocabulary bank and review with quizzes, audio and progress tracking.',
  coverPage: 3,
  units: UNITS,
  banks: [
    {
      id: 'grammar',
      title: 'Grammar Bank',
      description: 'Reference and practice for the grammar of each lesson, pages 96\u2013135.',
      pages: [96, 135],
    },
    {
      id: 'vocabulary',
      title: 'Vocabulary Bank',
      description: 'Words and phrases grouped by unit (including the Lead-in), pages 130\u2013146.',
      pages: [130, 146],
    },
    {
      id: 'writing',
      title: 'Writing Bank',
      description: 'Model texts and writing tasks for every unit, pages 94\u201395.',
      pages: [94, 95],
    },
    {
      id: 'mediation',
      title: 'Mediation Bank',
      description: 'Mediation skill tasks referenced in the lessons, pages 160\u2013161.',
      pages: [160, 161],
    },
  ],
