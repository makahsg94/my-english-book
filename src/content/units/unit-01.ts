      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'manager', meaningAr: 'مدير', example: 'a hotel manager, a business manager', exampleAr: 'مدير فندق، مدير أعمال' },
            { word: 'student', meaningAr: 'طالب', example: 'a university student', exampleAr: 'طالب جامعي' },
            { word: 'worker', meaningAr: 'عامل / موظف', example: 'an office worker, a farm worker', exampleAr: 'موظف مكتب، عامل مزرعة' },
          ],
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'have', meaningAr: 'يملك / لديه', example: 'have a car / a lot of money / two sisters', exampleAr: 'لديه سيارة / الكثير من المال / أختان' },
            { word: 'live', meaningAr: 'يعيش / يسكن', example: 'live in a village / with friends / alone', exampleAr: 'يعيش في قرية / مع أصدقاء / وحده' },
            { word: 'play', meaningAr: 'يلعب / يعزف', example: 'play the guitar / in a band / tennis', exampleAr: 'يعزف الجيتار / في فرقة / يلعب التنس' },
            { word: 'study', meaningAr: 'يدرس', example: 'study Italian / hard / every day', exampleAr: 'يدرس الإيطالية / بجد / كل يوم' },
            { word: 'teach', meaningAr: 'يُعلّم / يدرّس', example: 'teach students / at a university / English', exampleAr: 'يدرّس الطلاب / في جامعة / اللغة الإنجليزية' },
            { word: 'work', meaningAr: 'يعمل', example: 'work in a theatre / for a company / from home', exampleAr: 'يعمل في مسرح / في شركة / من المنزل' },
          ],
        },
        {
          type: 'text',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'hungry', meaningAr: 'جائع', example: 'I\u2019m hungry.', exampleAr: 'أنا جائع.' },
            { word: 'angry', meaningAr: 'غاضب', example: 'I\u2019m angry at my manager.', exampleAr: 'أنا غاضب من مديري.' },
            { word: 'relaxed', meaningAr: 'مرتاح / مسترخٍ', example: 'I feel really relaxed.', exampleAr: 'أشعر بارتياح شديد.' },
            { word: 'thirsty', meaningAr: 'عطشان', example: 'I\u2019m thirsty. Can I have some water?', exampleAr: 'أنا عطشان. هل يمكنني الحصول على بعض الماء؟' },
            { word: 'tired', meaningAr: 'متعب', example: 'I feel really tired.', exampleAr: 'أشعر بتعب شديد.' },
          ],
            ...
            questions: [
              {
                ...
                prompt: "Let\u2019s ___",
                options: [
                  { label: 'meet at the cinema.', correct: true },
                  { label: 'meet at half past seven?', correct: false },
                  { label: 'a break?', correct: false },
                  { label: 'three o\u2019clock?', correct: false },
                ],
              },
              {
                id: 'q2',
                ...
                prompt: 'Can we ___',
                options: [
                  { label: 'meet at half past seven?', correct: true },
                  { label: 'meet at the cinema.', correct: false },
                  { label: 'have a coffee?', correct: false },
                  { label: 'a break?', correct: false },
                ],
              },
              {
                id: 'q3',
                kind: 'mcq',
                prompt: 'Would you like to ___',
                options: [
                  { label: 'have a coffee?', correct: true },
                  { label: 'meet at the cinema.', correct: false },
                  { label: 'meet at half past seven?', correct: false },
                  { label: 'three o\u2019clock?', correct: false },
                ],
              },
              {
                id: 'q4',
                kind: 'mcq',
                prompt: 'How about ___',
                options: [
                  { label: 'a break?', correct: true },
                  { label: 'meet at the cinema.', correct: false },
                  { label: 'have a coffee?', correct: false },
                  { label: 'three o\u2019clock?', correct: false },
                ],
              },
              {
                id: 'q5',
                kind: 'mcq',
                prompt: 'What about ___',
                options: [
                  { label: 'three o\u2019clock?', correct: true },
                  { label: 'meet at the cinema.', correct: false },
                  { label: 'meet at half past seven?', correct: false },
                  { label: 'have a coffee?', correct: false },
                ],
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'this afternoon', meaningAr: 'هذا بعد الظهر', example: 'Let\u2019s meet this afternoon.', exampleAr: 'لنتقابل بعد الظهر.' },
            { word: 'at the weekend', meaningAr: 'في نهاية الأسبوع', example: 'How about at the weekend?', exampleAr: 'ما رأيك في نهاية الأسبوع؟' },
            { word: 'after class', meaningAr: 'بعد الحصة', example: 'Can we meet after class?', exampleAr: 'هل يمكننا أن نلتقي بعد الحصة؟' },
            { word: 'on Saturday', meaningAr: 'يوم السبت', example: 'Let\u2019s do something on Saturday.', exampleAr: 'لنفعل شيئاً يوم السبت.' },
          ],
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: "We're friends from work / school. / We're in a class together.", meaningAr: 'نحن صديقان من العمل / المدرسة. / نحن في صف واحد.', example: 'say how you know someone', exampleAr: 'تقول كيف تعرف شخصاً ما' },
            { word: "Who is he/she/Dan? / How do you know her/him?", meaningAr: 'من هو/هي/دان؟ / كيف تعرفها/تعرفه؟', example: 'ask about people', exampleAr: 'تسأل عن الأشخاص' },
            { word: 'Are you very good friends? / How often do you meet/talk?', meaningAr: 'هل أنتم أصدقاء مقربون جداً؟ / كم مرة تتقابلون/تتحدثون؟', example: 'ask for more information', exampleAr: 'تطلب المزيد من المعلومات' },
          ],
        },
        {
          type: 'text',
