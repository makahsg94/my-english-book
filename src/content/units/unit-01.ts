  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        ...
        { word: 'manager', meaning: 'the person who leads a team or a department', example: 'I have a really good manager. I look up to her.' },
        { word: 'close friend', meaning: 'a friend you know very well and trust', example: 'I also have a group of close friends and we sometimes play music together.' },
        ...
        { word: 'daughter', meaning: 'a female child', example: 'My daughter takes after my mother.' },
        { word: 'children', meaning: 'your sons or daughters', example: 'I want my children to have a good relationship with my parents.' },
      ],
    ...
    },
    {
      ...
      items: [
        { word: 'funny', meaning: 'making you laugh', example: "They're so funny, and great to be with." },
        { word: 'kind', meaning: 'caring about other people', example: "She's such a kind and generous person." },
        { word: 'generous', meaning: 'happy to give things or money to others', example: 'My grandfather is very generous with his time.' },
        { word: 'hard-working', meaning: 'working with effort', example: 'They are hard-working and very reliable.' },
        { word: 'reliable', meaning: 'someone you can depend on', example: 'She is a very reliable colleague.' },
        { word: 'cheerful', meaning: 'happy and positive', example: "She's always cheerful." },
        { word: 'calm', meaning: 'relaxed and not worried', example: 'It\u2019s amazing that he was so calm.' },
      ],
    },
    {
      type: 'audio',
...
const lesson1B: Lesson = {
  ...
  blocks: [
    ...
    },
    {
      ...
      title: 'jobs',
      items: [
        { word: 'chef', meaning: 'a person who cooks in a restaurant', example: 'A chef is responsible for planning the menu and creating new dishes.' },
        { word: 'musician', meaning: 'a person who plays music or sings', example: 'My brother is a musician.' },
        { word: 'mechanic', meaning: 'a person whose job is repairing cars and machines', example: 'The mechanic fixed our car very quickly.' },
        { word: 'financial consultant', meaning: 'a person who gives advice about money', example: "I'd like to be a financial consultant because they earn a good salary." },
        { word: 'shop assistant', meaning: 'a person who helps customers in a shop', example: 'The shop assistant recommended the blue jacket.' },
        { word: 'plumber', meaning: 'a person who repairs water pipes', example: 'We called a plumber to fix the kitchen tap.' },
        { word: 'gardener', meaning: 'a person who works in a garden', example: 'Our gardener looks after the plants once a week.' },
        { word: 'journalist', meaning: 'a person who writes for newspapers or websites', example: "My sister is a journalist." },
      ],
...
const lesson1C: Lesson = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        { word: 'clothes and fashion', example: "That's a nice jacket. Where did you get it?" },
        { word: 'food and eating out', example: 'Have you tried these pastries? They look delicious.' },
        { word: 'hobbies and free-time activities', example: 'What kinds of things do you paint?' },
        { word: 'holiday experiences', example: "We've just got back from Corfu. It was wonderful." },
        { word: 'politics', example: 'So, who do you think will win the election?' },
        { word: 'sport or music events', example: "It's the Big Music Live this weekend. Are you going?" },
        { word: 'the news', example: 'Did you hear about the fire in town? It\u2019s terrible.' },
        { word: 'the weather', example: "Lovely day, isn't it?" },
        { word: 'work or studies', example: 'I hear you have a job in finance. Do you enjoy it?' },
      ],
    },
    {
      type: 'text',
