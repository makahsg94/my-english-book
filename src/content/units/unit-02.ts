...
const lesson2A: Lesson = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        { word: 'bored', meaning: 'feeling unhappy because something is not interesting', example: 'We were bored, so we went into the garage.' },
        { word: 'exciting', meaning: 'making you feel excited', example: 'We were really excited when we found all dad\u2019s paints.' },
        { word: 'frightened', meaning: 'afraid of something', example: 'My sister and I were frightened.' },
        { word: 'embarrassed', meaning: 'feeling uncomfortable or ashamed about something', example: 'I think he found it a bit embarrassing.' },
        { word: 'annoyed', meaning: 'slightly angry', example: 'Dad is going to be really annoyed!' },
        { word: 'surprised', meaning: 'feeling that something unexpected has happened', example: "I'm surprised you chose blue." },
        { word: 'disappointed', meaning: 'unhappy because something was not as good as you hoped', example: 'He was probably disappointed with us.' },
        { word: 'amazed', meaning: 'very surprised', example: "It's amazing that he was so calm." },
      ],
...
const lesson2B: Lesson = {
  ...
  blocks: [
    ...
    },
    {
      ...
      title: 'story words',
      items: [
        { word: 'hero', meaning: 'the main person in a story', example: 'The hero of the film saves the town.' },
        { word: 'characters', meaning: 'the people in a story', example: 'The characters in this book are very realistic.' },
        { word: 'plot', meaning: 'the main events in a story', example: 'I think having an exciting plot is important.' },
        { word: 'ending', meaning: 'the way a story finishes', example: 'I like a happy ending, too.' },
        { word: 'storyteller', meaning: 'a person who tells the story', example: 'The storyteller at the festival was amazing.' },
        { word: 'performances', meaning: 'when people act or sing in front of people', example: "I love the actors' performances." },
        { word: 'fairytales', meaning: 'traditional stories for children', example: 'My grandmother told me fairytales.' },
        { word: 'TV shows', meaning: 'programmes which are shown on television', example: "It's the same with TV shows and films." },
      ],
        ...
        questions: [
          {
            ...
            kind: 'matching',
            pairs: [
              { left: 'hero', right: 'the main person in a story' },
              { left: 'characters', right: 'the people in a story' },
              { left: 'plot', right: 'the main events in a story' },
              { left: 'ending', right: 'the way a story finishes' },
              { left: 'storyteller', right: 'a person who tells the story' },
              { left: 'performances', right: 'when people act or sing in front of people' },
              { left: 'fairytales', right: 'traditional stories for children' },
              { left: 'TV shows', right: 'programmes which are shown on television' },
            ],
          },
        ],
      },
        ...
        questions: [
          {
            ...
            kind: 'matching',
            pairs: [
              { left: 'Boys go on a long journey to throw away a dangerous ring.', right: 'The Lord of the Rings' },
              { left: 'Girl travels to find a sister who can stop an ice age.', right: 'Frozen' },
              { left: "Great-grandma remembers the worst, most famous boat trip in history.", right: 'Titanic' },
              { left: "World's best theme park becomes world's most dangerous theme park.", right: 'Jurassic Park' },
              { left: 'Boy accidentally misses the family holiday and helps catch burglars at home.', right: 'Home Alone' },
            ],
          },
        ],
      },
...
const lesson2C: Lesson = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        { word: 'get off', meaning: 'to leave a bus or train', example: 'I got off at the wrong bus stop!' },
        { word: 'get lost', meaning: 'to not know where you are', example: 'Sorry I\u2019m late \u2013 I got lost!' },
        { word: 'get held up', meaning: 'to be delayed', example: 'I got held up at work.' },
        { word: 'get the wrong day/time/date/address', meaning: 'to understand something wrongly', example: 'I got the wrong day!' },
        { word: 'make a mistake', meaning: 'to do something wrong', example: 'I made a mistake with the address.' },
        { word: 'make a call', meaning: 'to phone someone', example: 'I had to make an urgent call.' },
        { word: 'make a plan', meaning: 'to agree to do something at a certain time', example: 'My partner made other plans and I didn\u2019t know until it was too late.' },
        { word: 'make a mess', meaning: 'to make something dirty or untidy', example: 'My little sister made a mess and I had to clean it up.' },
      ],
    },
    {
      type: 'exercise',
        ...
        questions: [
          {
            ...
            kind: 'matching',
            pairs: [
              { left: 'get off', right: 'to leave a bus or train' },
              { left: 'get lost', right: 'to not know where you are' },
              { left: 'get held up', right: 'to be delayed' },
              { left: 'get the wrong day', right: 'to understand something wrongly' },
              { left: 'make a mistake', right: 'to do something wrong' },
              { left: 'make a call', right: 'to phone someone' },
              { left: 'make a plan', right: 'to agree to do something at a certain time' },
              { left: 'make a mess', right: 'to make something dirty or untidy' },
            ],
          },
        ],
      },
    ...
    },
    {
      ...
      exercise: {
        id: 'u2-2c-listening',
        title: 'Match the conversation with the problem',
        kind: 'matching',
        instructions: 'Listen to six conversations and match each one with the problem (a-f).',
        page: 27,
        verified: true,
        questions: [
          {
            ...
            kind: 'matching',
            pairs: [
              { left: 'Conversation 1', right: 'a problem with a train' },
              { left: 'Conversation 2', right: 'a mistake with a class schedule' },
              { left: 'Conversation 3', right: 'a difficulty with technology' },
              { left: 'Conversation 4', right: 'a late flight' },
              { left: 'Conversation 5', right: 'a mistake with a package' },
              { left: 'Conversation 6', right: 'forgetting to charge a phone' },
            ],
          },
        ],
      },
