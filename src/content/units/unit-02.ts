      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'meat or fish', meaning: 'countable or uncountable', meaningAr: 'لحم أو سمك', example: 'salmon', exampleAr: 'سلمون' },
            { word: 'drinks', meaning: 'countable or uncountable', meaningAr: 'مشروبات', example: 'orange juice, lemonade', exampleAr: 'عصير برتقال، ليمونادة' },
            { word: 'other', meaning: 'countable and uncountable', meaningAr: 'أخرى', example: 'cheese, eggs, rice, yoghurt', exampleAr: 'جبن، بيض، أرز، زبادي' },
          ],
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'go running / shopping / for coffee / for lunch', meaningAr: 'يذهب للجري / للتسوق / لتناول القهوة / للغداء', example: 'I often meet friends for coffee.', exampleAr: 'غالباً ألتقي بأصدقاء لتناول القهوة.' },
            { word: 'go to a party / a meeting', meaningAr: 'يذهب إلى حفلة / اجتماع', example: 'Do you go to parties at the weekend?', exampleAr: 'هل تذهب إلى الحفلات في نهاية الأسبوع؟' },
            { word: 'meet someone online', meaningAr: 'يتعرف على شخص عبر الإنترنت', example: "I join online groups and I make new friends there.", exampleAr: 'أنضم إلى مجموعات عبر الإنترنت وأكوّن صداقات جديدة هناك.' },
            { word: 'spend time with your family / early / late', meaningAr: 'يقضي وقتاً مع عائلتك / مبكراً / متأخراً', example: 'I spend hours on social media.', exampleAr: 'أقضي ساعات على وسائل التواصل الاجتماعي.' },
          ],
        },
        {
          type: 'grammar',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'side dishes', meaning: 'extra dishes served with the main course', meaningAr: 'الأطباق الجانبية' },
            { word: 'desserts', meaning: 'sweet dish at the end of a meal', meaningAr: 'الحلويات' },
            { word: 'bill', meaning: 'the paper that shows what you must pay', meaningAr: 'الفاتورة' },
            { word: 'service charge', meaning: 'money you pay for the waiter\u2019s service', meaningAr: 'رسوم الخدمة' },
            { word: 'dinner for two', meaning: 'a meal for two people', meaningAr: 'عشاء لشخصين' },
          ],
        },
        {
          type: 'text',
            ...
            questions: [
              {
                id: 'q1',
                kind: 'mcq',
                prompt: 'Write the -ing form of the verb: wait',
                options: [
                  { label: 'waiting', correct: true },
                  { label: 'doing', correct: false },
                  { label: 'writing', correct: false },
                  { label: 'taking', correct: false },
                  { label: 'running', correct: false },
                  { label: 'getting up', correct: false },
                  { label: 'knowing', correct: false },
                  { label: 'playing', correct: false },
                ],
              },
              {
                id: 'q2',
                kind: 'mcq',
                prompt: 'Write the -ing form of the verb: do',
                options: [
                  { label: 'waiting', correct: false },
              ...
              },
              {
                id: 'q3',
                kind: 'mcq',
                prompt: 'Write the -ing form of the verb: write',
                options: [
                  { label: 'waiting', correct: false },
                  { label: 'doing', correct: false },
              ...
              },
              {
                id: 'q4',
                kind: 'mcq',
                prompt: 'Write the -ing form of the verb: take',
                options: [
                  { label: 'waiting', correct: false },
                  { label: 'doing', correct: false },
                  { label: 'writing', correct: false },
                  { label: 'taking', correct: true },
                  { label: 'running', correct: false },
                  { label: 'getting up', correct: false },
                  { label: 'knowing', correct: false },
                  { label: 'playing', correct: false },
              ...
              },
              {
                id: 'q5',
                kind: 'mcq',
                prompt: 'Write the -ing form of the verb: run',
                options: [
                  { label: 'waiting', correct: false },
                  { label: 'doing', correct: false },
                  { label: 'writing', correct: false },
              ...
              },
              {
                id: 'q6',
                kind: 'mcq',
                prompt: 'Write the -ing form of the verb: get up',
                options: [
                  { label: 'waiting', correct: false },
                  { label: 'doing', correct: false },
                  { label: 'writing', correct: false },
              ...
              },
              {
                id: 'q7',
                kind: 'mcq',
                prompt: 'Write the -ing form of the verb: know',
                options: [
                  { label: 'waiting', correct: false },
                  { label: 'doing', correct: false },
                  { label: 'writing', correct: false },
              ...
              },
              {
                id: 'q8',
                kind: 'mcq',
                prompt: 'Write the -ing form of the verb: play',
                options: [
                  { label: 'waiting', correct: false },
                  { label: 'doing', correct: false },
                  { label: 'writing', correct: false },
