  ...
  video: [
    {
      ...
      file: 'SO3 B1 U3 BBC StreetInt.mp4',
      page: 34,
    },
    {
      title: 'BBC Vlogs: homes and living spaces',
      file: 'SO3 B1 U3 BBC Vlogs.mp4',
      page: 35,
    },
  ],
  lessons: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { word: 'living room / lounge', example: 'TV, sofa, armchair, coffee table' },
            { word: 'kitchen', example: 'fridge, cooker, sink, worktop, cupboards' },
            { word: 'bedroom', example: 'bed, bedside table, wardrobe, mirror' },
            { word: 'bathroom', example: 'bath, shower, washbasin, towels' },
            { word: 'hall / hallway', example: 'front door, coat hooks' },
            { word: 'garden', example: 'flowers, grass, trees' },
          ],
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { word: 'soft', opposite: 'hard', example: 'a soft, comfortable chair' },
            { word: 'large / big', opposite: 'small', example: "It's too large, and you haven't got any space." },
            { word: 'easy', opposite: 'difficult', example: "It's difficult, but you CAN do it!" },
            { word: 'loud', opposite: 'quiet', example: 'play some loud music' },
            { word: 'long', opposite: 'short', example: 'It\u2019s got a long, short story!' },
            { word: 'same', opposite: 'different', example: 'They\u2019re the same, not different.' },
          ],
        },
        {
          type: 'grammar',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { word: "Sorry I'm late.", response: 'No problem.' },
            { word: 'Great to see you!', response: 'Thank you for a lovely evening!' },
            { word: 'These are for you.', response: 'Oh, thank you. How nice of you!' },
            { word: "Have a safe journey home.", response: 'You too.' },
            { word: "I'm full. That was delicious!", response: 'Glad you liked it!' },
          ],
        },
        {
          type: 'audio',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tracks: au(['R3.01', 'VB 3.01', 'VB 3.02']),
        },
        {
          type: 'pages',
