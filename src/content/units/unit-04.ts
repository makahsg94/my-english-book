      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'at', meaningAr: 'في (لأوقات محددة)', example: 'at night, at the weekend', exampleAr: 'في الليل، في نهاية الأسبوع' },
            { word: 'last', meaningAr: 'الماضي', example: 'last night, last Friday, last weekend, last month', exampleAr: 'الليلة الماضية، الجمعة الماضية، نهاية الأسبوع الماضية، الشهر الماضي' },
            { word: 'ago', meaningAr: 'قبل (مدة)', example: 'a month ago, a week ago, ten minutes ago', exampleAr: 'قبل شهر، قبل أسبوع، قبل عشر دقائق' },
            { word: 'yesterday', meaningAr: 'أمس', example: 'yesterday morning, yesterday evening', exampleAr: 'صباح أمس، مساء أمس' },
          ],
            ...
            questions: [
              {
                id: 'q1',
                kind: 'mcq',
                prompt: 'How do we say 9 January?',
                options: [
                  { label: 'the ninth of January', correct: true },
                  { label: 'the fourth of May', correct: false },
                  { label: 'the first of March', correct: false },
                  { label: 'the twelfth of December', correct: false },
                ],
              },
              {
                id: 'q2',
                kind: 'mcq',
                prompt: 'How do we say 4 May?',
                options: [
                  { label: 'the ninth of January', correct: false },
              ...
              },
              {
                id: 'q3',
                kind: 'mcq',
                prompt: 'How do we say 1 March?',
                options: [
                  { label: 'the ninth of January', correct: false },
                  { label: 'the fourth of May', correct: false },
                  { label: 'the first of March', correct: true },
                  { label: 'the twelfth of December', correct: false },
                ],
              },
              {
                id: 'q4',
                kind: 'mcq',
                prompt: 'How do we say 12 December?',
                options: [
                  { label: 'the ninth of January', correct: false },
                  { label: 'the fourth of May', correct: false },
                  { label: 'the first of March', correct: false },
                  { label: 'the twelfth of December', correct: true },
                ],
              },
            ],
          },
...
type: 'grammar',
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'under a hundred', meaning: 'below 100', meaningAr: 'أقل من مئة' },
            { word: 'about a hundred', meaning: 'around 100', meaningAr: 'حوالي مئة' },
            { word: 'exactly a hundred', meaning: '100', meaningAr: 'مئة بالضبط' },
            { word: 'over a hundred', meaning: 'above 100', meaningAr: 'أكثر من مئة' },
          ],
            ...
            questions: [
              {
                id: 'q1',
                kind: 'mcq',
                prompt: 'Which phrase describes 70?',
                options: [
                  { label: 'just under a hundred', correct: true },
                  { label: 'nearly a hundred', correct: false },
                  { label: 'about a hundred', correct: false },
                  { label: 'exactly a hundred', correct: false },
                  { label: 'just over a hundred', correct: false },
                  { label: 'over a hundred', correct: false },
                ],
              },
              {
                id: 'q2',
                kind: 'mcq',
                prompt: 'Which phrase describes 98?',
                options: [
                  { label: 'just under a hundred', correct: false },
                  { label: 'nearly a hundred', correct: true },
                  { label: 'about a hundred', correct: false },
                  { label: 'exactly a hundred', correct: false },
                  { label: 'just over a hundred', correct: false },
                  { label: 'over a hundred', correct: false },
              ...
              },
              {
                id: 'q3',
                kind: 'mcq',
                prompt: 'Which phrase describes 98–102?',
                options: [
                  { label: 'just under a hundred', correct: false },
                  { label: 'nearly a hundred', correct: false },
                  { label: 'about a hundred', correct: true },
                  { label: 'exactly a hundred', correct: false },
                  { label: 'just over a hundred', correct: false },
                  { label: 'over a hundred', correct: false },
                ],
              },
              {
                id: 'q4',
                kind: 'mcq',
                prompt: 'Which phrase describes 100?',
                options: [
                  { label: 'just under a hundred', correct: false },
                  { label: 'nearly a hundred', correct: false },
                  { label: 'about a hundred', correct: false },
                  { label: 'exactly a hundred', correct: true },
                  { label: 'just over a hundred', correct: false },
                  { label: 'over a hundred', correct: false },
                ],
              },
              {
                id: 'q5',
                kind: 'mcq',
                prompt: 'Which phrase describes 102?',
                options: [
                  { label: 'just under a hundred', correct: false },
                  { label: 'nearly a hundred', correct: false },
                  { label: 'about a hundred', correct: false },
                  { label: 'exactly a hundred', correct: false },
                  { label: 'just over a hundred', correct: true },
                  { label: 'over a hundred', correct: false },
                ],
              },
              {
                id: 'q6',
                kind: 'mcq',
                prompt: 'Which phrase describes 140?',
                options: [
                  { label: 'just under a hundred', correct: false },
                  { label: 'nearly a hundred', correct: false },
                  { label: 'about a hundred', correct: false },
                  { label: 'exactly a hundred', correct: false },
                  { label: 'just over a hundred', correct: false },
                  { label: 'over a hundred', correct: true },
                ],
              },
            ],
          },
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'chemist\u2019s / pharmacy', meaning: 'medicine and toothpaste', meaningAr: 'صيدلية' },
            { word: 'clothes shop', meaning: 'clothes', meaningAr: 'متجر ملابس' },
            { word: 'clothes shop (big)', meaning: 'many kinds of clothes', meaningAr: 'متجر ملابس (كبير)' },
            { word: 'delicatessen', meaning: 'special foods', meaningAr: 'متجر أطعمة فاخرة' },
            { word: 'electrical shop', meaning: 'phones, computers', meaningAr: 'متجر إلكترونيات' },
            { word: 'florist\u2019s', meaning: 'flowers', meaningAr: 'متجر زهور' },
            { word: 'shoe shop', meaning: 'shoes', meaningAr: 'متجر أحذية' },
            { word: 'supermarket', meaning: 'food and everyday things', meaningAr: 'سوبر ماركت' },
          ],
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'cloudy', meaning: 'with clouds', meaningAr: 'غائم' },
            { word: 'windy', meaning: 'with wind', meaningAr: 'عاصف' },
            { word: 'rainy / raining', meaning: 'with rain', meaningAr: 'ممطر / تمطر' },
            { word: 'snowy / snowing', meaning: 'with snow', meaningAr: 'مثلج / تثلج' },
            { word: 'hot / warm / cold / freezing', meaning: 'temperature words', meaningAr: 'حار / دافئ / بارد / متجمد' },
            { word: 'wet / dry', meaning: 'with / without rain', meaningAr: 'مبلل / جاف' },
          ],
