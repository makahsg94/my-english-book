  ...
  lessons: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          title: 'the arts',
          items: [
            { word: 'musician', meaning: 'someone who is paid to play a musical instrument' },
            { word: 'the arts', meaning: 'music, writing, art, literature, film, etc.' },
            { word: 'performer', meaning: 'someone who plays music or acts in public' },
            { word: 'recording', meaning: 'something that is recorded so people can watch or listen again in the future' },
            { word: 'painter', meaning: 'a person who paints pictures' },
            { word: 'style', meaning: 'the way a work of art looks' },
            { word: 'subjects', meaning: 'the things you are writing about, drawing or discussing' },
            { word: 'composer', meaning: 'someone who writes music' },
            { word: 'works', meaning: 'the things that artists create (music, books, etc.)' },
            { word: 'image', meaning: 'any kind of picture' },
          ],
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { word: 'imagine / imagination / imaginative', meaning: 'verb / noun / adjective' },
            { word: 'create / creativity / creative', meaning: 'verb / noun / adjective' },
            { word: 'art / art / artistic', meaning: 'noun / noun / adjective' },
            { word: 'photograph / photography / photographic', meaning: 'verb / noun / adjective' },
            { word: 'skill / skill / skilful', meaning: 'verb / noun / adjective' },
            { word: 'talent / talent / talented', meaning: 'verb / noun / adjective' },
          ],
        },
        {
          type: 'audio',
            ...
            questions: [
              {
                ...
                kind: 'matching',
                pairs: [
                  { left: 'Roza, film-maker', right: 'I look for new ways to do things.' },
                  { left: 'Fabio, chef', right: 'I try to experience new situations.' },
                  { left: 'Joshua, designer', right: 'I use nature for inspiration.' },
                  { left: 'Meera, accountant', right: "I need to be creative when looking after my daughter." },
                ],
              },
            ],
          },
            ...
            questions: [
              {
                ...
                kind: 'matching',
                pairs: [
                  { left: 'although / while', right: 'contrast' },
                  { left: 'because / because of', right: 'reason' },
                  { left: 'unless', right: 'condition' },
                ],
              },
            ],
          },
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { word: 'good', meaning: 'normal adjective', example: "We can say 'very good'. We can't say 'very fantastic'." },
            { word: 'fantastic', meaning: 'extreme adjective', example: "We can say 'absolutely fantastic'. We can't say 'absolutely good'." },
            { word: 'bad / terrible', meaning: 'normal / extreme' },
            { word: 'interesting / fascinating', meaning: 'normal / extreme' },
            { word: 'big / huge', meaning: 'normal / extreme' },
            { word: 'small / tiny', meaning: 'normal / extreme' },
            { word: 'important / essential', meaning: 'normal / extreme' },
            { word: 'difficult / impossible', meaning: 'normal / extreme' },
          ],
        },
        {
          type: 'callout',
            ...
            questions: [
              {
                ...
                kind: 'matching',
                pairs: [
                  { left: 'good', right: 'fantastic' },
                  { left: 'bad', right: 'terrible' },
                  { left: 'interesting', right: 'fascinating' },
                  { left: 'big', right: 'huge' },
                  { left: 'small', right: 'tiny' },
                  { left: 'important', right: 'essential' },
                  { left: 'difficult', right: 'impossible' },
                ],
              },
            ],
          },
        ...
        },
        {
          ...
          items: [
            { word: 'asking for an opinion', meaning: 'How about you? / What makes you say that? / What do/did you think of\u2026?', response: 'What do you think about it?' },
            { word: 'giving an opinion', meaning: 'Forme,\u2026 / In my view,\u2026 / I think\u2026 / I would say\u2026', response: 'In my view, it\u2019s a really new and exciting design.' },
            { word: 'asking for a reason', meaning: 'Why do you think that?', response: 'Why do you think that?' },
            { word: 'giving a reason', meaning: 'The reason is\u2026 / It\u2019s because\u2026', response: 'It\u2019s because it\u2019s free.' },
            { word: 'agreeing to disagree', meaning: 'I suppose we\u2019re all different. / I guess it\u2019s good we\u2019re not all the same.', response: 'I guess we all like different things.' },
          ],
        },
        {
          type: 'exercise',
