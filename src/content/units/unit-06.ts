  ...
  lessons: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { word: 'jumper, T-shirt, jacket, shirt, skirt, top, hat, jeans, trainers', meaning: 'items of clothing' },
            { word: 'tall / short', meaning: 'height' },
            { word: 'long hair / short hair', meaning: 'hair' },
            { word: 'blonde', meaning: 'hair colour' },
            { word: 'beard / moustache', meaning: 'facial hair' },
            { word: 'checked', meaning: 'pattern in squares' },
          ],
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { word: 'short', opposite: 'long', example: 'a short journey' },
            { word: 'dangerous', opposite: 'safe', example: 'a safe route' },
            { word: 'expensive', opposite: 'cheap', example: 'a cheap ticket' },
            { word: 'difficult', opposite: 'easy', example: 'an easy journey' },
            { word: 'noisy', opposite: 'quiet', example: 'a quiet street' },
            { word: 'quick / fast', opposite: 'slow', example: 'a slow boat' },
            { word: 'boring', opposite: 'interesting', example: 'an interesting route' },
            { word: 'comfortable', opposite: 'uncomfortable', example: 'a comfortable seat' },
          ],
        },
        {
          type: 'vocab',
          ...
          items: [
            { word: 'go by car / train / bus / plane / boat / bike', example: 'I usually go by train.' },
            { word: 'go on foot', example: 'It\u2019s ten minutes on foot.' },
            { word: 'take a taxi / the bus / a plane', example: 'We took a taxi to the airport.' },
            { word: 'ride a bike', example: 'She rides a bike to school.' },
            { word: 'drive a car', example: 'He drives to work.' },
          ],
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { word: 'pedestrian bridge', meaning: 'a bridge for people on foot' },
            { word: 'crossroads', meaning: 'where two roads cross' },
            { word: 'traffic lights', meaning: 'lights that control traffic' },
            { word: 'corner', meaning: 'the place where two streets meet' },
            { word: 'square', meaning: 'an open space in a town' },
            { word: 'car park', meaning: 'a place to park cars' },
            { word: 'bus stop', meaning: 'the place where buses stop' },
            { word: 'statue', meaning: 'a model of a person made of stone or metal' },
          ],
        },
        {
          type: 'grammar',
...
title: 'BBC Programmes: Cities: nature\u2019s new wild',
        ...
        },
        {
          ...
          items: [
            { word: 'out of', meaning: 'from inside to outside (walk out of my building)' },
            { word: 'into', meaning: 'from outside to inside (go into a house)' },
            { word: 'towards', meaning: 'in the direction of (walk towards me)' },
            { word: 'past', meaning: 'going by (walk past my car)' },
            { word: 'along', meaning: 'following the length of (along the road)' },
            { word: 'across', meaning: 'from one side to the other (cross the river)' },
            { word: 'through', meaning: 'in one side and out the other (walk through the park)' },
            { word: 'up / down', meaning: 'going to a higher / lower place' },
            { word: 'back', meaning: 'returning (come back)' },
          ],
