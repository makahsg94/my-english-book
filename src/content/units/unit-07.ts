      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'be good with people\u2019s names', meaning: 'remember names easily', meaningAr: 'أن تكون جيداً في تذكّر أسماء الناس' },
            { word: 'work long hours', meaning: 'work for a long time', meaningAr: 'أن تعمل ساعات طويلة' },
            { word: 'work alone', meaning: 'work by yourself', meaningAr: 'أن تعمل وحدك' },
            { word: 'work with your hands', meaning: 'practical, manual work', meaningAr: 'أن تعمل بيديك (عمل يدوي)' },
            { word: 'be good at / with animals, numbers, languages', meaning: 'have ability', meaningAr: 'أن تكون جيداً في / مع الحيوانات، الأرقام، اللغات' },
          ],
...
title: 'An extra day',
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'pick up', meaningAr: 'يلتقط / يجمع', example: 'pick up rubbish', exampleAr: 'يجمع القمامة' },
            { word: 'look up', meaningAr: 'يبحث عن', example: 'look up information on the internet', exampleAr: 'يبحث عن معلومة على الإنترنت' },
            { word: 'turn off', meaningAr: 'يُطفئ', example: 'turn off your phone', exampleAr: 'أطفئ هاتفك' },
            { word: 'clean up', meaningAr: 'ينظّف / يرتّب', example: 'clean up your bedroom', exampleAr: 'رتّب غرفة نومك' },
          ],
        },
        {
          type: 'exercise',
            ...
            questions: [
              {
                id: 'q1',
                kind: 'mcq',
                prompt: "Which phrase goes with 'look after'?",
                options: [
                  { label: 'the elephants', correct: true },
                  { label: 'your job', correct: false },
                  { label: 'rubbish', correct: false },
                  { label: 'information on the internet', correct: false },
                  { label: 'your phone', correct: false },
                  { label: 'your bedroom', correct: false },
                ],
              },
              {
                id: 'q2',
                kind: 'mcq',
                prompt: "Which phrase goes with 'give up'?",
                options: [
                  { label: 'the elephants', correct: false },
                  { label: 'your job', correct: true },
                  { label: 'rubbish', correct: false },
                  { label: 'information on the internet', correct: false },
                  { label: 'your phone', correct: false },
                  { label: 'your bedroom', correct: false },
              ...
              },
              {
                id: 'q3',
                kind: 'mcq',
                prompt: "Which phrase goes with 'pick up'?",
                options: [
                  { label: 'the elephants', correct: false },
                  { label: 'your job', correct: false },
                  { label: 'rubbish', correct: true },
                  { label: 'information on the internet', correct: false },
                  { label: 'your phone', correct: false },
                  { label: 'your bedroom', correct: false },
                ],
              },
              {
                id: 'q4',
                kind: 'mcq',
                prompt: "Which phrase goes with 'look up'?",
                options: [
                  { label: 'the elephants', correct: false },
                  { label: 'your job', correct: false },
                  { label: 'rubbish', correct: false },
                  { label: 'information on the internet', correct: true },
                  { label: 'your phone', correct: false },
                  { label: 'your bedroom', correct: false },
                ],
              },
              {
                id: 'q5',
                kind: 'mcq',
                prompt: "Which phrase goes with 'turn off'?",
                options: [
                  { label: 'the elephants', correct: false },
                  { label: 'your job', correct: false },
                  { label: 'rubbish', correct: false },
                  { label: 'information on the internet', correct: false },
                  { label: 'your phone', correct: true },
                  { label: 'your bedroom', correct: false },
                ],
              },
              {
                id: 'q6',
                kind: 'mcq',
                prompt: "Which phrase goes with 'clean up'?",
                options: [
                  { label: 'the elephants', correct: false },
                  { label: 'your job', correct: false },
                  { label: 'rubbish', correct: false },
                  { label: 'information on the internet', correct: false },
                  { label: 'your phone', correct: false },
                  { label: 'your bedroom', correct: true },
                ],
              },
            ],
          },
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'hold on a second / minute / moment', meaning: 'wait a short time', meaningAr: 'انتظر لحظة' },
            { word: 'leave / send / delete a message', meaning: 'voicemail actions', meaningAr: 'اترك / أرسل / احذف رسالة' },
            { word: 'call / phone / ring you back', meaning: 'return the call', meaningAr: 'أعاود الاتصال بك' },
            { word: 'press 2', meaning: 'press 2 on the keypad', meaningAr: 'اضغط 2 (على لوحة المفاتيح)' },
            { word: 'voicemail', meaning: 'a system that records messages', meaningAr: 'البريد الصوتي' },
          ],
        },
        {
          type: 'grammar',
