...
title: 'Trip advice',
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'wonderful', meaning: 'very good', meaningAr: 'رائع' },
            { word: 'hills', meaning: 'areas of high land', meaningAr: 'تلال' },
            { word: 'old town', meaning: 'the historical part of a town', meaningAr: 'البلدة القديمة' },
            { word: 'pretty shops and caf\u00e9s', meaning: 'attractive places to shop and eat', meaningAr: 'متاجر ومقاهٍ جميلة' },
            { word: 'at the top of a hill', meaning: 'on the highest part of a hill', meaningAr: 'على قمة التل' },
            { word: 'forest', meaning: 'a large area with many trees', meaningAr: 'غابة' },
          ],
        },
        {
          type: 'grammar',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'go shopping / sightseeing', meaning: 'visit shops / famous places', meaningAr: 'يذهب للتسوق / لمشاهدة المعالم' },
            { word: 'take photos', meaning: 'photograph the sights', meaningAr: 'يلتقط صوراً' },
            { word: 'try the local food', meaning: 'eat local specialities', meaningAr: 'يتذوق الطعام المحلي' },
            { word: 'use an app or a guidebook', meaning: 'navigate yourself', meaningAr: 'يستخدم تطبيقاً أو دليل سفر' },
            { word: 'visit famous places', meaning: 'see the sights', meaningAr: 'يزور أماكن مشهورة' },
            { word: 'going with a local guide', meaning: 'explore with a local person', meaningAr: 'الذهاب مع مرشد محلي' },
          ],
        },
        {
          type: 'grammar',
...
title: 'At a hotel',
        ...
        },
        {
          ...
          items: [
            ...
            { word: 'take the lift', meaning: 'use the elevator', meaningAr: 'يستخدم المصعد' },
            { word: 'order room service', meaning: 'ask for food in your room', meaningAr: 'يطلب خدمة الغرف' },
            { word: 'pay your bill', meaning: 'settle your account', meaningAr: 'يدفع فاتورتك' },
            { word: 'keep something in the safe', meaning: 'store valuables securely', meaningAr: 'يحفظ شيئاً في الخزنة' },
            { word: 'print your boarding pass', meaning: 'print your flight card', meaningAr: 'يطبع بطاقة الصعود' },
            { word: 'leave your luggage at reception', meaning: 'deposit bags at the desk', meaningAr: 'يترك أمتعتك في الاستقبال' },
            { word: 'airport transfer', meaning: 'transport to/from the airport', meaningAr: 'نقل من/إلى المطار' },
          ],
