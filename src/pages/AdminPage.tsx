...
import { IconShield, IconHome, IconTrash, IconRefresh, IconClock, IconEye, IconFlame, IconChat } from '../components/Icons'
...
function ageOf(row: AdminRow): string | null {
  ...
  const d = row.data
  if (d && typeof d === 'object') {
    const p = (d as Record<string, unknown>)['speakout-a2.profile.v1']
